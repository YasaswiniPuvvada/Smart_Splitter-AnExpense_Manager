...
public class FileManager {
    ...
    private static final String EXPENSE_FILE = "src/data/expenses.txt";
    ...
    public static List<Group> loadGroups() {
        ...
        File file = new File("src/data/groups.txt");
    ...
    public static void saveGroups(List<Group> groups) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("src/data/groups.txt"))) {
